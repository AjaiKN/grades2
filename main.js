...
var author$project$Main$getPageLink = function (model) {
	var url = author$project$Main$getPageUrl(model);
	return A2(
		elm$html$Html$a,
		_List_fromArray(
			[
...
var author$project$Main$makeTableFromRows = F2(
	function (headers, l) {
		...
		return A2(
			...
			A2(
				elm$core$List$cons,
				A2(makeRow, elm$html$Html$th, headers),
				A2(
					elm$core$List$map,
...
var author$project$Main$viewTabLink = F3(
	function (isCurrentTab, click, label) {
		...
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('tablinks' + activeClass),
...
var author$project$Main$numInput = F3(
	function (changer, val, label) {
		return A2(
			elm$html$Html$span,
			_List_Nil,
			_List_fromArray(
...
var author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$text('Link to this calculation: '),
				author$project$Main$getPageLink(model),
